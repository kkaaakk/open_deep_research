...
See [src/legacy/graph.ipynb](https://github.com/langchain-ai/open_deep_research/blob/main/src/legacy/graph.ipynb) and [src/legacy/multi_agent.ipynb](https://github.com/langchain-ai/open_deep_research/blob/main/src/legacy/multi_agent.ipynb) for example usage in a Jupyter notebook:
